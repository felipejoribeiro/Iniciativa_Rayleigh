...
program sphereworld2
   ...
   call glutInitDisplayMode(ior(GLUT_DOUBLE, &
        ior(GLUT_RGB,ior(GLUT_DEPTH,ior(GLUT_STENCIL,GLUT_MULTISAMPLE)))))
...
subroutine SetupRC
   ...
   integer(glenum), parameter:: GL_MULTISAMPLE_ARB = z'809D'
  ...
  !call glEnable(GLUT_MULTISAMPLE)
   ...
   call glFogfv(GL_FOG_COLOR, LowLight)
   call glFogi(GL_FOG_MODE, GL_LINEAR)
   call glFogf(GL_FOG_START, 5.0)
   call glFogf(GL_FOG_END, 30.0)
