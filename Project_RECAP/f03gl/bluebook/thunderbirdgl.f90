...
module spheremod
   ...
   type(CTriangleMesh), save :: thunderBirdBody
   type(CTriangleMesh), save :: thunderBirdGlass
...
subroutine setuprc
   ...
   call CT_BeginMesh(thunderbirdbody,3704*3)
   ...
   do i=1,3704 ! Loop through all the faces
     ...
     call CT_AddTriangle(thunderbirdbody,v(1,1),n(1,1),t(1,1))
   end do
   call CT_EndMesh(thunderbirdbody)
   call CT_ScaleMesh(thunderbirdbody,Scale)
   
   ! Now do the same for the canopy
   write(*,*)'glass'
   call CT_BeginMesh(thunderbirdglass,352*3)
   ...
   do i=1,352
     ...
     call CT_AddTriangle(thunderbirdglass,v,n,t)
   end do

   call CT_EndMesh(thunderbirdglass)
   call CT_ScaleMesh(thunderbirdglass,Scale)
  ...
  !call glEnable(GL_RESCALE_NORMAL)
   ...
   call MoveForward (frameCamera,-20.)
