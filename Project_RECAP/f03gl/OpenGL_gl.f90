module OpenGL_kinds
  ...
  ! Integer types:
  integer, parameter :: &
    GLbyte     = C_SIGNED_CHAR, &
    GLshort    = C_SHORT, &
    GLint      = C_INT, &
    GLsizei    = C_INT, &
    GLboolean  = C_SIGNED_CHAR, &
    GLenum     = C_INT, &
    GLbitfield = C_INT, &
    GLcint     = C_INT, &
    GLubyte    = C_SIGNED_CHAR, &
    GLushort   = C_SHORT, &
    GLuint     = C_INT
  ! Real types:
  integer, parameter :: &
...
INTEGER(GLint), PARAMETER :: GL_PASS_THROUGH_TOKEN    = 1792 ! 0x0700
INTEGER(GLint), PARAMETER :: GL_POINT_TOKEN           = 1793 ! 0x0701
INTEGER(GLint), PARAMETER :: GL_LINE_TOKEN            = 1794 ! 0x0702
INTEGER(GLint), PARAMETER :: GL_POLYGON_TOKEN         = 1795 ! 0x0703
INTEGER(GLint), PARAMETER :: GL_BITMAP_TOKEN          = 1796 ! 0x0704
INTEGER(GLint), PARAMETER :: GL_DRAW_PIXEL_TOKEN      = 1797 ! 0x0705
INTEGER(GLint), PARAMETER :: GL_COPY_PIXEL_TOKEN      = 1798 ! 0x0706
INTEGER(GLint), PARAMETER :: GL_LINE_RESET_TOKEN      = 1799 ! 0x0707
!  FogMode values
...
!
! Henk: blue book example chapter 9: gl_repeat should be float 
! NEE dus boek is fout
!
INTEGER(GLenum), PARAMETER :: GL_REPEAT                = z'2901' ! 0x2901
!real(GLfloat), PARAMETER :: GL_REPEAT                = float(z'2901') ! 0x2901
...
INTEGER(GLbitfield), PARAMETER :: GL_CLIENT_ALL_ATTRIB_BITS = z'ffffffff' ! 0xffffffff
