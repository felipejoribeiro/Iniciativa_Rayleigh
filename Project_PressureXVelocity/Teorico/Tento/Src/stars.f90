...
! Determina-se  as constantes usadas no algorítmo!
real(gldouble), parameter :: M_PI = 3.14159265358979323846_gldouble
integer(glenum), parameter :: NORMAL = 0, WEIRD = 1
integer(glenum), parameter :: STREAK = 0, CIRCLE = 1
...
! Funções associadas aos módulos!
contains
