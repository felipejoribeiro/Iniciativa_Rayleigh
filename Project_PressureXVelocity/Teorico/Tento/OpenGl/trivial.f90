...
module trivial
  ...
  subroutine display() bind(C)
    ...
    call glvertex3f( 0.25_glfloat, 0.25_glfloat + real( 2 * abs(sin(tempo))), 0.0_glfloat)
  ...
  subroutine close() bind(C)

    use opengl_gl
    use opengl_glu
    use opengl_glut

    call glutDestroyWindow(iwin)
