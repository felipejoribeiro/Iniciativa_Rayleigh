		...
		\begin{figure}[h]
			\begin{center}
				\begin{tikzpicture}[node distance = 1.5cm, auto]
					...
					\node[diam, below of=step2, node distance=2.5cm] (step3){Is the result ok?};
					\node[rect, left of=step3, node distance=3.5cm] (step4){Do};
					\node[rect, rounded corners, below of=step3, node distance=2.5cm](step5){end};
